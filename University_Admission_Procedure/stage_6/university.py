class University:
    ...
    def sort_by_priority(self, applicants, priority, dept) -> list:
        ...
        dep_appls_exams = [[applt[0]] + [self.mean([applt[exam] for exam in self.departments[dept]])] for applt in dep_appls]
